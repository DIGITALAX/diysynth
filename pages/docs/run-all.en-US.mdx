...
Looking to get started right away? `AI Tools & Resources` from [`Pharmapsychotic`](https://pharmapsychotic.com/") has been a helpful resource to many of us. You can skip to a quick taste of hands on experience of prompt slinging at [`DreamStudio`]("https://beta.dreamstudio.ai/home"), [`Artbreeder`]("artbreeder.com"), [`NightCafe`]("https://nightcafe.studio/"), [`Photoleap`]("https://www.photoleapapp.com/"), and many more. Nothing better for a new artist in any medium than to get a feel for the kind of instruments you'll be using.

But, we think you'll find messing with how simple bits of prompts thrown together in a semi-random way only gets you so far. It can get underwhelming before you know it.

You'll soon want a stronger dose of the real stuff – like what you can find in many community sourced [`Google Colab notebooks`]("colab.research.google.com"). [`Read more`](/docs/community-research) about prompt engineering, modifiers, artist combinations, weights, and how to tweak a wide variety of settings to get much better results.
